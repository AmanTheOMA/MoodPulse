...
export default function Dashboard() {
    ...
    try {
      ...
      const newData = {
        ...
        [year]: {
          ...userDataObject?.[year],
          [month]: {
            ...userDataObject?.[year]?.[month],
            [day]: mood,
          },
        },
      };

      console.log("Saving data to Firestore:", newData);
  ...
  useEffect(() => {
    ...
    console.log("Loading user data:", userDataObject);
    setData(userDataObject);
  }, [currentUser, userDataObject]);

  if (!currentUser) {
    return <Login initialMode={mode === "signup" ? "register" : "login"} />;
  }
